...
class UserVehiclePark extends Model
{
    //
     ...
     * @var array
     */
    protected $fillable = array('id', 'is_visible', 'is_active', 'user_id', 'park_id', 'status_id', 'date_time_create');
    ...
    */
    ...
    public function park(){
        return $this->belongsTo('App\Park', 'park_id', 'id');
    }
