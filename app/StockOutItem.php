...
class StockOutItem extends Model
{
     ...
     * @var array
     */
    protected $fillable = array('id', 'is_visible', 'is_active', 'status_id', 'item_id', 'unit_price', 'quantity', 'stockable_type', 'stockable_id', 'referenceable_type', 'referenceable_id', 'stock_out_id', 'date_time_create');
    ...
    */
    ...
    public function stockOut(){
        return $this->belongsTo('App\StockOut', 'stock_out_id', 'id');
    }
