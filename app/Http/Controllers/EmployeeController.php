...
class EmployeeController extends Controller
{
    ...
    public function create(Request $request){
        ...
        try {
            ...
            $userObject = $userObject->whereHas('employee', function($query){
        ...
        if(view()->exists('pages.employee_reg')){
            return View::make('pages.employee_reg', $data);
        }else{
                ...
                */
                ...
                if( $userObject ){
                    ...
                    $employeeObjectArray = array(
                        $userObject->employee()->firstOrCreate([
                            //'id' => $request->input('id'),
                            'is_visible' => true,
                            'is_active' => true,
