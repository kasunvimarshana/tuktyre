...
{
    protected $table_name_1 = "measure_units";
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up()
    {
        Schema::create($this->table_name_1, function (Blueprint $table) {
            ...
            */
            ...
            $table->string('symbol')->nullable()->comment('comment');//->index()
            ...
            $table->unsignedBigInteger('measure_unit_id_parent')->unsigned()->nullable()->comment('comment');//->index()
