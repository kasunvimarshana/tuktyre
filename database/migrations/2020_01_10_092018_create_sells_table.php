    ...
    public function up()
    {
        Schema::create($this->table_name_1, function (Blueprint $table) {
            ...
            */
            ...
            //$table->double('amount_payment')->nullable()->default(0)->comment('comment');//->index()
            $table->double('amount_discount')->nullable()->default(0)->comment('comment');//->index()
            $table->double('amount_down_payment')->nullable()->default(0)->comment('comment');//->index()
            $table->double('amount_credit')->nullable()->default(0)->comment('comment');//->index()
            ...
            $table->unsignedBigInteger('user_vehicle_id_customer')->unsigned()->nullable()->comment('comment');//->index()
