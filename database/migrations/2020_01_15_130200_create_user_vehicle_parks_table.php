...
class CreateUserVehicleParksTable extends Migration
{
    protected $table_name_1 = "user_vehicle_parks";
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up()
    {
        Schema::create($this->table_name_1, function (Blueprint $table) {
            ...
            */
            ...
            $table->unsignedBigInteger('park_id')->unsigned()->nullable()->comment('comment');//->index()
