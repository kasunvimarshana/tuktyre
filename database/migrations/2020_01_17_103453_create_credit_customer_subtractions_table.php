...
class CreateCreditCustomerSubtractionsTable extends Migration
{
    protected $table_name_1 = "credit_customer_subtractions";
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up()
    {
        Schema::create($this->table_name_1, function (Blueprint $table) {
            ...
            */
            ...
            $table->unsignedBigInteger('credit_customer_in_id')->unsigned()->index()->nullable()->comment('comment');
            ...
            //$table->double('installment_number')->index()->nullable()->default(0)->comment('comment');
