...
{
    protected $table_name_1 = "vehicles";
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up()
    {
        Schema::create($this->table_name_1, function (Blueprint $table) {
            ...
            */
            ...
            $table->boolean('is_tangible')->nullable()->default(false)->comment('comment');//->index()
            ...
            $table->unsignedBigInteger('vehicle_type_id')->unsigned()->nullable()->comment('comment');//->index()
            $table->string('vehicle_licence_number')->nullable()->comment('comment');//->index()
            //$table->unsignedBigInteger('vehicle_id_parent')->unsigned()->nullable()->comment('comment');//->index()
