...
<div class="container-fluid  container-a">
   <div class="row">
      ...
      <div class="col-md-8  section-a-left">
         <p class="nav-head">Stock > Batteries</p>
      </div>
   ...
   <div class="row">
      <div class="  col-md-8 section-b-right table-div">
         ...
         <legend class="scheduler-border">
               <h3>Details of batteries stock</h3>
            </legend>
      ...
      <div class="col-md-4  section-b-left">
                  <fieldset class="scheduler-border">
                     ...
                     <form role="form" action="{!! route('stockInBattery.store', []) !!}" method="POST" class="" autocomplete="off" id="form1" enctype="multipart/form-data">
                         <!-- --- -->
                          @csrf
                         <!-- --- -->
                        <div class="card-body">
                        ...
                        <div class="card-footer col-md-6">
                         New Stock : 
                         <a href="/tyrestock">Tyre</a> | <a href="/alloywheelsstock">Alloywheel</a>
                         </div>
