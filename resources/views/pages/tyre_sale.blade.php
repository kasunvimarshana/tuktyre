...
<!-- header | open  -->
    ...
    <div class="row">
        ...
        <div class="col-md-8  section-a-left">
            <p class="nav-head">Sales > Tyres</p>
        </div>
            ...
            <div class="row">
               ...
               <div class="col-md-4  section-b-left">
                  <fieldset class="scheduler-border">
                     ...
                     <form role="form" action="{!! route('sellTyre.store', []) !!}" method="POST" class="" autocomplete="off" id="form1" enctype="multipart/form-data">
                         <!-- --- -->
                          @csrf
                         <!-- --- -->
                        <div class="card-body">
